% FIGURE 2: d11B AND pH TIMESERIES
% Madison Shankle
% 18-08-2021

% Plots a two-paneled figure of timeseries of d11B and pH and saves it as a
% PDF.
...
east = xlsread('Fig2_Shankle_east_pH_results.xls');
west = xlsread('Fig2_Shankle_west_pH_results.xls');
east_avgs = xlsread('Fig2_Shankle_east_pH_avgs.xls');
west_avgs = xlsread('Fig2_Shankle_west_pH_avgs.xls');
...
ThreeMa = xlsread('Fig2_MB15_3Ma_pH.xls');
...
saveas(gcf,'Fig2_Shankle_d11B-pH-timeseries.pdf')  
