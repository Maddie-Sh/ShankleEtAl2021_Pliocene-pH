...
input = readtable('Shankle_MC_input.xlsx');  
...
% % % %         Omegaerflat = 2;    %  ( = [Ca2+][CO32-] / Ksp). % SCRIPT USES THIS ONE
% % %         Omegaerflat = 0;
        % Updated by MS 01-10-2020 to calc pCO2 with mod Alk instead of mod calcite saturation state (omega)
...
% % %         Omegamc = Omega + rand*Omegaerflat ; % - 1; % JWBR: note that have made Omega flat
        % Updated by MS 01-10-2020 to calc pCO2 with mod Alk instead of mod calcite saturation state (omega)
